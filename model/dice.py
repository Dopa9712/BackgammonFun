# model/dice.py - Dice model for handling dice rolls

import random


class Dice:
    """Handles the dice logic for the backgammon game."""
    ...
    def roll(self):
        ...
        return self.values.copy(), is_doubles
    ...
    def get_used_indices(self):
        """Get indices of used dice.

        Returns:
            list: List of indices of used dice
        """
        return [i for i, used in enumerate(self.used) if used]
