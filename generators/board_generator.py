#!/usr/bin/env python3
# board_generator.py - Generates and saves a backgammon board image
...
def generate_backgammon_board(width=1024, height=768):
    """Generate a backgammon board image and save it to the assets directory."""
    # Initialize pygame
    pygame.init()
    ...
    # Draw home indicators (smaller now)
    home_width = 20
    ...
    # Report success
    print(f"Backgammon board image saved to assets/images/backgammon_board.png")
...
if __name__ == "__main__":
    ...
    generate_backgammon_board(width, height)